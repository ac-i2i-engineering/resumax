"""
Django settings for resumax_backend project.
...
ROOT_URLCONF = 'resumax_backend.urls'
TEMPLATES = [
    {
...
WSGI_APPLICATION = 'resumax_backend.wsgi.application'
# Database
...
USE_RETRIEVAL_BASED_RESPONSE = True